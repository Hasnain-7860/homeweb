...
const Testimonials = () => {
  return (
    <div className='container  mx-auto py-10 lg:px-32 overflow-hidden' id='Testimonials'>
        ...
        <p className=' text-center text-gray-500 mx-auto max-w-80 mb-8 '>Real Stories from Those Who Found Home with Us</p>
        <div className='flex flex-wrap justify-center gap-8'>
          {testimonialsData.map((data,index)=>(
            <div key={index}className='max-w-[340px] border shadow-lg rounded px-8 py-12 text-center' >
              <img className='w-20 h-20 rounded-full mx-auto mb-4' src={data.image} alt={data.alt} />
